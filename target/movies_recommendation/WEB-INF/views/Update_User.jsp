...
<body>
	<div class="register_form_user">
		...
		<form:form name="RegForm" onsubmit="return validateForm()"
			action="Update_User_Again" method="Post" modelAttribute="updateuser"  id="myForm">
			<p>
				<input type="text" id="name" name="user_name"
					placeholder="Enter your name:" maxlength="50" value="${user_namen}"/> <span id="name-error"
					class="error-message"></span>
			</p>
			<p>
				<input type="password" placeholder="Enter your Password:"
					id="password" name="user_password" maxlength="50"  value="${user_passwordn}"
					required autocomplete="off" oncopy="return false" onpaste="return false" oncut="return false"/>
					 <span id="password-error"
					class="error-message"></span>
                <!-- Eye icon for password visibility toggle -->
                <span class="eye-icon" onclick="togglePasswordVisibility()">
                    <img id="eye-image" src="/movies_recommendation/resources/images/open_eye.png" alt="Show Password">
                </span>							
			</p>
			...
			<p>
				<input type="text" id="Email" name="user_email"
					placeholder="Enter your email:" maxlength="60" value="${user_emailn}"/> <span
					id="emailValidationMessage" class="error-message"></span>
			</p>
			<p>
				<input type="text" id="contactnumber" name="user_contact"
					placeholder="Enter your Contact Number:" required maxlength="10" value="${user_contactn}"
					/> <span
					id="validationcontactMessage" class="error-message"></span>
			</p>
			<p>
				<input type="text" id="city" name="user_city"
					placeholder="Enter your City Name:" maxlength="50" value="${user_cityn}"
					/> <span
...
function togglePasswordVisibility() {
    ...
    if (passwordInput.type === "password") {
        ...
        eyeImage.src = "/movies_recommendation/resources/images/closed_eye.png"; // Change to hide password image
        eyeImage.alt = "Hide Password";
    } else {
        passwordInput.type = "password";
        eyeImage.src = "/movies_recommendation/resources/images/open_eye.png"; // Change to show password image
