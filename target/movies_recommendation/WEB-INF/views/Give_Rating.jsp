		...
		<c:forEach var="m" items="${Details_of_Movies}">
			...
			action="Current_user_giving_rating" method="Post" >
					...
					<div class="popup-content">
					      	<input type="hidden" placeholder="Give the user_id" name="user_id" value="${Current_user_id}"> 
	
							<input type="hidden" placeholder="Give the m_id" name="m_id" value="${m.m_id}"> 

							<label for="rating"
							id="getm"><h3>Rating (1-5 stars):</h3></label> <select name="rating"
							id="rating">
						...
						<label for="review" id="getm"><h3>Review:</h3></label>
