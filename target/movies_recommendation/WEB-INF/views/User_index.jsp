			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<div class="navbar-categories-menu">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item active"><a class="nav-link" href="#"><h3 class="text-white" >Home</h3>
								<span class="sr-only">(current)</span></a></li>
						<li class="nav-item"><a class="nav-link" href="#"><h3 class="text-white">TV
									shows</h3></a></li>
				...
				<div class="navbar-profile-menu">
					<li class="nav-item dropdown"><a class="profile-section"
						aria-expanded="false"><img class="profile-img"
							src="/movies_recommendation/resources/images/user.png" alt="">
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu"
										...
										<li><a class="dropdown-item" href="#"><button
													id="myButton-Admin_login">Watch List</button></a>
										</li>
										
												<li><a class="dropdown-item" href="#"><button
													id="myButton-Admin_login">Planes And Offers</button></a>
										</li>
										
												<li><a class="dropdown-item" href="#"><button
													id="myButton-Region">India</button></a>
										</li>
