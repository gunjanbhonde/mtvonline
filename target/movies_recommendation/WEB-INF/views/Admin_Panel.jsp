...
<div class="container">
    ...
    <form:form  id="movieForm" name="frm" action="add_new_movie" method="Post"
								modelAttribute="add_movie" enctype="multipart/form-data">
        <!-- Movie Title -->
        <div class="form-group">
            <label for="movie_title">Movie Title:</label>
            <input type="text" id="movie_title" name="movie_title"  maxlength="500" required >
        </div>

        <!-- Movie Mapping Name -->
        <div class="form-group">
            <label for="movie_mapping_name">Movie Mapping Name:</label>
            <input type="text" id="movie_mapping_name" name="movie_mapping_name"  maxlength="500" required>
        ...
        <div class="form-group">
            ...
            <textarea id="movie_desc" name="movie_desc" rows="4" maxlength="800" required></textarea>
        </div>

        <!-- Movie Category -->
            <div class="form-group">
                <label for="movie_category">Movie Category:</label>
                <button type="button" id="categoryBtn">Select Movie Category</button>
                <div class="selected-categories" id="selectedCategories">Action</div>
                <!-- Hidden input to store selected categories -->
                <input type="hidden" id="movie_category" name="movie_category" value="Action">
            </div>

        <!-- Movie Director Name -->
        <div class="form-group">
            <label for="movie_director_name">Movie Director Name:</label>
            <input type="text" id="movie_director_name" name="movie_director_name" maxlength="100" required>
        </div>

        <!-- Movie Actors -->
        <div class="form-group">
            <label for="movie_actor_1">Actor 1:</label>
            <input type="text" id="movie_actor_1" name="movie_actor_1" maxlength="100" required>
        </div>
        <div class="form-group">
            <label for="movie_actor_2">Actor 2:</label>
            <input type="text" id="movie_actor_2" name="movie_actor_2" maxlength="100" >
        </div>
        <div class="form-group">
            <label for="movie_actor_3">Actor 3:</label>
            <input type="text" id="movie_actor_3" name="movie_actor_3" maxlength="100">
        </div>
        ...
        <!-- Movie Trailer Link -->
        <div class="form-group">
            <label for="movie_trailer_link">Movie Trailer Link:</label>
            <input type="text" id="movie_trailer_link" name="movie_trailer_link" maxlength="1000">
        </div>

        <!-- Movie Watch Link -->
        <div class="form-group">
            <label for="movie_watch_link">Movie Watch Link:</label>
            <input type="text" id="movie_watch_link" name="movie_watch_link" maxlength="1000">
        </div>

        <!-- Movie Budget -->
        <div class="form-group">
            <label for="movie_budget">Movie Budget:</label>
            <input type="text" id="movie_budget" name="movie_budget" maxlength="20" required>
        </div>

        <!-- Movie Release Date -->
        <div class="form-group">
            <label for="movie_release_date">Movie Release Date:</label>
            <input type="date" id="movie_release_date" name="movie_release_date" required>
        </div>

        <!-- Movie Country -->
        <div class="form-group">
            <label for="movie_country">Movie Country:</label>
            <input type="text" id="movie_country" name="movie_country" maxlength="120" required>
        </div>

        <!-- Upload Image -->
        <div class="form-group">
            <label for="movie_image">Upload Movie Image:</label>
            <input type="file" id="movie_image" name="movie_image" accept=".jpg, .jpeg" required>
  ...
  <!-- Movie Category Popup -->
    ...
    <div class="popup" id="categoryPopup">
        ...
        <div class="checkbox-list">
            ...
            <label><input type="checkbox" value="Children's"> Children's</label>
            <label><input type="checkbox" value="Television"> Television</label>
            ...
            <label><input type="checkbox" value="Comedy drama"> Comedy drama</label>
            <label><input type="checkbox" value="Art"> Art</label>
            <label><input type="checkbox" value="Narrative"> Narrative</label>
            <label><input type="checkbox" value="Historical drama"> Historical drama</label>
        </div>
        <p class="error" id="category_error"></p>
        <button type="button" id="addCategoriesBtn">Add Categories</button>
    </div>
...
<!-- 	=====================================================================================================================================	 -->
						<div id="movie-update" class="form-section">
							<form>

								<label for="movie-id">Movie ID:</label> <input type="text"
									id="movie-id"> <label for="movie-name-update">Movie
									Name:</label> <input type="text" id="movie-name-update" maxlength="50">
								<label for="movie-description-update">Movie Description:</label>
								<input type="text" id="movie-description-update" maxlength="200">
								<label for="movie-category-update">Category:</label> <select
									id="movie-category-update">
								...
								</select> <label for="director-name-update">Director Name:</label> <input
									type="text" id="director-name-update" maxlength="50"> <label
									for="actor1-name-update">Actor 1 Name:</label> <input
									type="text" id="actor1-name-update" maxlength="50"> <label
									for="actor2-name-update">Actor 2 Name:</label> <input
									type="text" id="actor2-name-update" maxlength="50"> <label
									for="actor3-name-update">Actor 3 Name:</label> <input
									type="text" id="actor3-name-update" maxlength="50"> <label
									for="movie-budget-update">Movie Budget:</label> <input
									type="text" id="movie-budget-update" maxlength="50"> <label
									for="release-date-update">Release Date:</label> <input
									type="date" id="release-date-update"> <label
									for="country-name-update">Country:</label> <input type="text"
									id="country-name-update" maxlength="50"> <label
									for="Movie-image">Upload Movie Image:</label> <input
									type="file" id="Movie-image-update">
								<button type="submit">Update Movie</button>
							</form>
						</div>
						<div id="movie-delete" class="form-section">
							<form>
								<label for="delete-movie-id"><h4>Delete Movie by
										ID:</h4></label> <input type="text" id="delete-movie-id">
								<button type="submit">
									<h3>Delete Movie</h3>
								</button>
							</form>
					...
					<div id="admin" class="section">
						...
						<div id="admin-add" class="form-section" style="margin-top: 5%">
							...
							<form:form name="frm" action="add_new_admin" method="Post"
								modelAttribute="add_admin">
								<input type="text" id="admin-name" name="adminname"
									maxlength="50" placeholder="Admin Name: " />
								<input type="password" id="admin-password" name="adminpassword"
									maxlength="50" placeholder="Admin Password:" />
								<button type="submit" onclick="solve()">Add Admin</button>
							</form:form>
							<%--     ${Add_New_Admin_msg} --%>
						</div>
						<div id="admin-update" class="form-section" style="margin-top: 5%">
							...
							<form:form name="frm" action="update_admin" method="Post"
								modelAttribute="Update_admin">

								<input type="hidden" id="admin-id" name="aid" maxlength="5"
									value="${admin_id}" />
								<input type="text" id="admin-name" name="adminname"
									maxlength="50" value="${admin_name}" />
								<input type="password" id="admin-password" name="adminpassword"
									maxlength="50" value="${admin_password}" />
								<button type="submit" onclick="solve()">Update Admin</button>
