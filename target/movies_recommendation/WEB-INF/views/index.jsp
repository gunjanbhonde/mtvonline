...
<link type="text/css" rel="stylesheet"
	href="/movies_recommendation/resources/css/style.css" />
			...
			<div class="collapse navbar-collapse " id="navbarSupportedContent">
				<div class="navbar-categories-menu">
					<ul class="navbar-nav mr-auto ">
						<li class="nav-item active text-light "><a class="nav-link " href="#"><h3 class="text-white ">Home</h3>
								<span class="sr-only">(current)</span></a></li>
						<li class="nav-item"><a class="nav-link" href="#"><h3 class="text-white text-red-hover">TV
									shows</h3></a></li>
						<li class="nav-item"><a class="nav-link" href="#"><h3 class="text-white">Movies</h3></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="#"><h3 class="text-white">Web
									series</h3></a></li>
						<li class="nav-item"><a class="nav-link" href="#"><h3 class="text-white">Channels</h3></a>
						</li>
				...
				<div class="navbar-profile-menu">
					<li class="nav-item dropdown"><a class="profile-section"
						aria-expanded="false"><h3 class="text-white">Profile</h3> </a>
						<div class="dropdown-menu">

							<a class="dropdown-item" href="userlogin"><button
								...
								<a class="dropdown-item" href="#"><button
									...
									id="myButton-Region">
									<img
										src="/movies_recommendation/resources/images/Indian_flag.png"
										alt="">
									<h3>India</h3>
								</button></a> <a class="dropdown-item" href="#"><button
									id="myButton-User_login">
				...
				<div class="Buy-plan"> 
					<a href="Buy_Plan_Page"><button class="Buy-plan-button"
						...
						<img src="/movies_recommendation/resources/images/crown.png"
							alt="">
						<h3>BUY PLAN</h3>
					</button></a>
		...
		<!-- website-section-1-banner-starting -->
			...
			<div id="carouselExampleCaptions" class="carousel slide"
				...
				<div id="movieCarousel" class="carousel slide"
					data-bs-ride="carousel" data-bs-interval="60000"
					data-bs-wrap="true">
						...
						<c:forEach var="banner" items="${bannersList}" varStatus="status">
							<div class="carousel-item ${status.index == 0 ? 'active' : ''}">
								<img
									...
									style="height: 500px; width: 100%;" class="d-block w-100"
...
preloadImages(imageUrls.split(','), function () {
    $('#movieCarousel').carousel({ interval: 3000, wrap: true });
		...
		<!-------------- section-4-add-section-starting----------->
		 <div class="section-4-add-banner">
			<a href="#"><img
				src="${pageContext.request.contextPath}/resources/images/Ad_1.jpg"
				alt=""></a>
		</div> 
	...
	<div class="wrapper_tablet_view">
							...
							<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu"
										...
										<li><a class="dropdown-item" href="userlogin">
												<button id="myButton-User_login">Log in</button>
										</a></li>
										<li><a class="dropdown-item" href="adminlogin"><button
													id="myButton-Admin_login">Admin</button></a></li>
		...
		<div class="section-2-Trending-Top-10-main_desktop">
			<div class="section-2-trending-1">
				<h1>Top Hollywood film picks</h1>
			</div>
			<div class="parent-2-1">
				<div class="scroll-container-2-1">
					<c:forEach var="hollywood" items="${HollywoodList}">
